 ...
 */
final class Version20231210194812 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, description VARCHAR(255) DEFAULT NULL, stock INT NOT NULL, fichier VARCHAR(255) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, utilisateurid_id INT DEFAULT NULL, date DATETIME NOT NULL, montant_total DOUBLE PRECISION NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_6EEAA67DEBE08276 (utilisateurid_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE messagerie (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, user_mail VARCHAR(255) NOT NULL, motif VARCHAR(255) NOT NULL, description VARCHAR(511) NOT NULL, date DATETIME NOT NULL, fichier VARCHAR(255) DEFAULT NULL, image_name VARCHAR(255) DEFAULT NULL, INDEX IDX_14E8F60CFB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
